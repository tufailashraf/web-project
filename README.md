...
```
git clone https://github.com/tufailashraf/web-project
cd web-project
```
...
The website is hosted on Vercel. Each time new changes are pushed to GitHub, the website auto-deploys.
...
Suggestions (like adding subjects or quizzes) are highly encouraged.
